...
```
Let's make sure our health gets changed when we collide, so update our collision condition **in the for loop** to reduce health by 0.1 each frame we're colliding:

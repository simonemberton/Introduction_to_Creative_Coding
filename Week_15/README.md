...
Let's add some text so that the value of the ```timer``` variable is shown on the screen.  
...
*****
### &#x1F536; Task 6 - Game Flow / Game Over - Second code challenge
...
### &#x1F536; Task 8 - Using images - Third Code Challenge

```diff
! Replace the circle with an image (like my 8 bit cat)   
```

*(Note for modern p5.js / p5.js 2.0: To ensure images are fully loaded before draw runs, use `async function setup()` and `img = await loadImage('assets/cat.png');`, or use `preload()` in p5.js 1.x.)*

### &#x1F536; Task 9 - Playability - Fourth Code Challenge
...
### &#x1F536; Task 10 - Playability - Fifth Code Challenge
...
### &#x1F536; Task 11 - Complexity - Sixth Code Challenge
